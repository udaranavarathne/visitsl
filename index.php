...
<html lang="en">
  <head>
    ...
    <meta charset="utf-8">
	<meta name="description" content="Create your own holiday with good Tour Operators in Sri Lanka. We’ll help you to plan your holiday in sri lanka and we will arrange all your travel arrangements in Sri Lanka at an affordable price.">
  <meta name="keywords" content="Sri Lanka,Visit Sri lanka ,Sri lanka tourism,travel sri lanka,sri lanka tour,travel to sri lanka,visit sri lanka,visit sri lanka holidays,trip to srilanka,tourist in sri lanka,sri lanka travel and tours,lanka holidays,tours in sri lanka,travel and tours,about sri lanka,travel websites,srilankan,srilanka,sri lanka tourist board ">
  ...
  <div class="site-wrap">
    ...
    <div class="slide-one-item home-slider owl-carousel">
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(images/Yala.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(images/Kandy.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
        ...
        <div class="nonloop-block-13 owl-carousel">
            ...
            <div class="container">
              <div class="row">
                  <div class="col-lg-6 mb-5">
                      <img src="images/Testimonials/Yvonne-Carne-Ross.jpg" alt="Image" class="img-md-fluid">
                  </div>
          ...
          <div class="item">
            <div class="container">
              <div class="row">
                  <div class="col-lg-6 mb-5">
                      <img src="images/Testimonials/lee-sproat.jpg" alt="Image" class="img-md-fluid">
                  </div>
                  <div class="overlap-left col-lg-6 bg-white p-md-5 align-self-center">
          ...
          <div class="item">
            <div class="container">
              <div class="row">
                <div class="col-lg-6 mb-5">
                    <img src="images/Testimonials/Liz-Dickson.jpg" alt="Image" class="img-md-fluid">
                </div>
                <div class="overlap-left col-lg-6 bg-white p-md-5 align-self-center">
...
Barwon Heads , Australia.;</p>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center">
            <h2 class="font-weight-light text-black">Our PACKAGES</h2>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
              ...
              <div class="unit-1-text">
                ...
                <h3 class="unit-1-heading">Pre Planned Packages</h3>
              </div>
            </a>
          </div>
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
              ...
              <div class="unit-1-text">
                <strong class="text-primary mb-2 d-block">From $50 per day</strong>
                <h3 class="unit-1-heading">Create your own tour</h3>
              </div>
            </a>
          </div>
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
              ...
              <div class="unit-1-text">
                ...
                <h3 class="unit-1-heading">Excrusions</h3>
              </div>
            </a>
          </div>
    ...
    <div class="site-blocks-cover overlay inner-page-cover" style="background-image: url(images/message.jpg); background-attachment: fixed;">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">

          <div class="col-md-7" data-aos="fade-up" data-aos-delay="400">
            <h6 class="text-white font-weight-light mb-5 h1"> "Our hearts and thoughts are with the bereaved families & loved ones and of all those injured by the tragic incident occurred on Easter Sunday that struck churches and hotels in Sri Lanka."</h6>
